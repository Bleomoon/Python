...
import pandas as pd
penguin_data = pd.read_csv("../datasets/penguins_classification.csv")
penguin_data.head()
# 2 numerical and 1 categorical

target_column = 'Species'
penguin_data[target_column].value_counts()
_ = penguin_data.hist(figsize=(20,14))
...
_ = sns.pairplot(data=penguin_data[:n_samples_to_plot], vars=columns,
                 hue=target_column, plot_kws={'alpha': 0.2},
                 height=3, diag_kind='hist', diag_kws={'bins': 30})
